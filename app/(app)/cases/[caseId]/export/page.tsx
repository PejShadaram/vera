  ...
  return (
    <div style={{ fontFamily: "Georgia, 'Times New Roman', serif", maxWidth: 800, margin: "0 auto", padding: "40px 32px", color: "#1C1917", lineHeight: 1.6 }}>
      ...
      <div className="no-print" style={{ marginBottom: 32, display: "flex", gap: 12 }}>
        <ExportPrintButton />
        <a href={`/cases/${caseId}`}
          style={{ border: "1px solid #E8E2D9", color: "#78716C", padding: "10px 24px", borderRadius: 8, fontFamily: "Georgia, 'Times New Roman', serif", fontSize: 14, fontWeight: 500, textDecoration: "none", display: "inline-block" }}>
          ← Back to case
        </a>
      </div>
